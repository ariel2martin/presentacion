  ...
  <v-carousel hide-delimiters height="100%">
    <transition name="bounce">
      <v-alert
        ...
        dark
      >
        Esta aplicación administra una reunión de juegos entre personas,
        comienza con un listado de jugadores importado o escrito a mano, los
        pone en grupos al azar según cuántas mesas de juego se disponga, y en la
        siguiente pantalla se puede anotar los puntajes que va consiguiendo cada
        grupo y grafica el progreso
...
export default {
  ...
  data() {
    return {
      ...
      posicionDuplicada: [],
      listado: [
        { nombre: "Juan Cespedes", grupo: "G8" },
        { nombre: "Claudia Villafañe", posicion: "", grupo: "G8" },
        { nombre: "Jhon Doe", posicion: "10", grupo: "G7" },
        { nombre: "Fulano de tal", posicion: "6" },
        { nombre: "Hilda Lizarazu", posicion: "4" },
        { nombre: "Lidia Moyano", posicion: "3" },
        { nombre: "Thomas Edison", posicion: "2" },
        { nombre: "Americo Vespucio", posicion: "1" },
      ],
  ...
  mounted() {
    ...
    //console.warn(pun);
    if (pun == null || pun.length == 0) {
      pun = [
        { grupo: "G8", value: [0, 7, -4, 2], puntos: [0, 7, 3, 5], total: 5 },
        { grupo: "G7", value: [0, 1, 2, 0], puntos: [0, 1, 3, 3], total: 3 },
      ];
    }
    this.puntaje = pun;
    ...
    let esdemo = JSON.parse(localStorage.getItem("listado"));
    if (esdemo == null) {
      esdemo = [
        { nombre: "Juan Cespedes", grupo: "G8" },
        { nombre: "Claudia Villafañe", posicion: "", grupo: "G8" },
  ...
  destroyed() {
    document
      .getElementById("file")
      .removeEventListener("input", this.readFile, false);
